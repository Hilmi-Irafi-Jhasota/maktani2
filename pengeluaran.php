<?php 
    ...
    $pengeluaran = query("SELECT * FROM pengeluaran WHERE  username = '$ambilNama'");
?>
...
<head>
    ...
    <title>Mak-Tani - Pengeluaran</title>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-hover table-striped table-bordered">
                                    ...
                                    <tr class="show" id="<?= $row['id'] ?>">
                                        ...
                                        <td data-target="jumlahbanyak"><?= htmlspecialchars($row['jumlahbanyak']) ?></td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id="keperluanTambah" class="form-control">
                                <option>Pupuk</option>
                                <option>peralatan bertani</option>
                                <option>Gaji Pekerja</option>
                                <option>Benih/Bibit</option>
                                <option>Pestisida</option>
                                <option>Lain - lain</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Masukkan jumlah(kg/pcs)</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="jumlahKeluar">Jumlah (kg/pcs)</label>
                        <input type="text" class="form-control" id="jumlahbanyak" onkeydown="return numbersonly(this, event);"
                            onkeyup="javascript:tandaPemisahTitik(this);" required>
                    </div>
                    <div class="form-group">
