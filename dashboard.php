<?php 
    ...
    $JUMLAHBERAT= query ("SELECT * FROM `pemasukkan` ORDER BY `pemasukkan`.`JUMLAHBERAT` ASC");
...
<head>
    ...
    <title>Mak-Tani - Dashboard</title>
...
<body>
                                ...
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center tulisan">
                                            <div class="numbers">
                                                <p class="card-category ket head">Jumlah Panen</p>
                                                <?php foreach ($totalPemasukan as $row) : ?>
                                                        <?php
                                                            $hargaPemasukkan[] = $row["JUMLAHBERAT"];
                                                    ...
                                                    if ( $hasilHarga != "" ) : ?>
                                                    <h4 class="card-title ket total"><?= $hasilHarga ?> kg</h4>
                                                    <?php else : ?>
                                                    <h4 class="card-title ket total"> 0 kg </h4>
                                                    <?php endif; ?>
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            type: 'horizontalBar',
            data: {
                labels: ["JUMLAHBERAT", "PENGELUARAN","PEMASUKAN"],
                datasets: [{
                    label: 'Data rekening',
                    data: [
                        <?= $hasilHarga ?>, 
