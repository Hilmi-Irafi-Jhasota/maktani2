...
<head>
    ...
    <title>Mak-Tani - Tambah Data</title>
                    ...
                    <div class="konten_isi">
                        <table class="table-sm">
                            ...
                            <form class="form-text" action="" method="post">
                                ...
                                <tr>
                                    <td>Masukkan Jumlah Berat Panen</td>
                                    <td>:</td>
                                    <td><input class="form-control" type="text" name="JUMLAHBERAT" autocomplete="off" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" required></td>
                                </tr>
                                <tr>
