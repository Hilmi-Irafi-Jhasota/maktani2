<?php 
	...
	$pemasukkan = query("SELECT * FROM pemasukkan WHERE  username = '$ambilNama'");
?>
...
<head>
	...
	<title>Mak-Tani - Pemasukkan</title>
...
<body>
	<div class="header">
		...
		<h3 class="text-secondary font-weight-bold float-left logo">Mak</h3>
		<h3 class="text-secondary float-left logo2">-Tani</h3>
		<a href="logout">
			<div class="logout">
									...
									<div class="table-responsive">
										<table class="table table-sm table-hover table-striped table-bordered">
											...
											<tr class="show" id="<?= $row['id'] ?>">
													...
													<td data-target="JUMLAHBERAT"><?= htmlspecialchars($row['JUMLAHBERAT']) ?></td>
											...
											<tr>
													...
													<td id="total" data-target="total"><?= $hasilJumlah3 ?></td>
													<td id="total" data-target="total"><?= $hasilJumlah ?></td>
											
											<?php endif; ?>
											<?php if(isset($jumlah3) != null) :?>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<select name="sumber" class="form-control" id="sumberTambah">
									<option>penjualan hasil panen</option>
							</select>
						</div>
						<div class="form-group">
							<label>Masukkan Jumlah Berat</label>
							<input type="text" id="JUMLAHBERAT" name="JUMLAHBERAT" class="form-control" onkeydown="return numbersonly(this, event);"
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="jumlahBerat">Jumlah berat panen</label>
							<input type="text" class="form-control" id="JUMLAHBERAT" onkeydown="return numbersonly(this, event);"
										onkeyup="javascript:tandaPemisahTitik(this);" required>
						</div>
						<div class="form-group">
